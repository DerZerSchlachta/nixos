{ ... }:
{
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."2048x1152 screen: Width" = 1315;
      ...
      "kcminputrc"."Libinput/1133/16511/Logitech G502"."ScrollFactor" = 1;
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."2a4e2cdf-103c-4df2-bbb7-894268292217" = "1bb900c5-8aa1-49b8-808b-cd849424a3f8";
      "kwinrc"."Desktops"."Id_1" = "22c891f2-a44a-4b3c-a1f8-6cc8aaa4d35d";
      "kwinrc"."Desktops"."Id_2" = "1bb900c5-8aa1-49b8-808b-cd849424a3f8";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/johannes/Games/Heroic/Prefixes/default/BeamNG.drive[v.0.36]/pfx/drive_c/users/steamuser/AppData/Local/BeamNG.drive/0.36/mods/B93pkwMG";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 698;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-ToolView-kate_plugin_katesearch-Visible" = true;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 34;
